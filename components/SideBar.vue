...
<template>
  ...
  >
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-900">
      <h2 class="text-3xl font-bold p-2 text-white mb-2">Qualyval</h2>
      <ul class="space-y-2 font-medium">
        <li>
          ...
          >
            <svg
              aria-hidden="true"
              class="w-6 h-6 text-gray-300 transition duration-75 group-hover:text-gray-900"
              fill="currentColor"
              viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg"
            >
        ...
        <li>
          ...
          >
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              class="w-6 h-6 text-gray-300 transition duration-75"
        ...
        <h3 class="text-gray-400 uppercase px-2 py-3">organization</h3>
